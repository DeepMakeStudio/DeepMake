...
class ButtonList(QDialog):
    ...
    def addListItem(self, text):
        ...
        button.clicked.connect(
            lambda: self.changeVersion(text))
    ...
    def changeVersion(self, text):
        ...
        p = subprocess.Popen(f"git checkout tags/{text} -b <branch_name>".split(), stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        p.wait()
